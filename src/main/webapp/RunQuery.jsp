...
<%
// java expressions below
    PrintWriter output = response.getWriter();  // getWriter returns a PrintWriter object that can send char text to client
    response.setContentType("application/json");
    response.setCharacterEncoding("UTF-8");

    String tab_id = request.getParameter("tab_id");

// create a report   tab_id 0 for create report
    // note: reusing createReport code in HttpServlet
    if (tab_id.equals("0")) {
